# IntegrationNet v4.1 Discord Announcement Index

This file is the chronological index for IntegrationNet v4.1 release announcements. Each release
candidate has its own file so a new announcement does not overwrite the historical record.

| Release | Network update | Status | Announcement |
|---|---|---|---|
