...
Configuration lives in `modules/node-shared/src/main/resources/application.conf` under keys like `last-legacy-state-proof-ordinal` and `incremental-delegated-staking-starting-ordinal`.
