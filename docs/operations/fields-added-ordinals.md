...
| `fixing-allow-spend-and-token-lock-validation` | 5058096 | 9999999 | 5848000 | 0 |
| `set-sum-fix` | 9999999 | 9999999 | 5848000 | 0 |
...
| `fields-added-ordinals.delegated-rewards-full-committee` | 5,848,000 | `ordinal >= gate` | Switches delegated recipients from historical evidence filtering to every Core + Tier-1 member |
