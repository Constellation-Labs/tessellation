...
object Main
  ...
  def sendTxsUsingGeneratedWallets[F[_]: Async: Files: Random: KryoSerializer: SecurityProvider: Console](
    client: Client[F],
    basicOpts: BasicOpts,
  ...
  def sendTxsUsingLoadedWallets[F[_]: Async: Files: Random: KryoSerializer: SecurityProvider: Console](
    client: Client[F],
    basicOpts: BasicOpts,
