...
object kryo {
  type ProtocolKryoRegistrationIdRange = GreaterEqual[300]
  type ProtocolKryoRegistrationId = KryoRegistrationId[ProtocolKryoRegistrationIdRange]

  val schemaKryoRegistrar: Map[Class[_], ProtocolKryoRegistrationId] = Map(
