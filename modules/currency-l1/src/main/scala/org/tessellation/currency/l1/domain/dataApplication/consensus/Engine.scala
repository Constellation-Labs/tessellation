...
import org.tessellation.currency.dataApplication.DataTransaction.{DataTransactions, getHashes}
...
case class RoundData(
  ...
  def formBlock[F[_]: Async](
    validateUpdate: DataTransactions => F[Either[String, DataTransactions]],
