...
/** Utility class for decimal operations and conversions. Provides consistent handling of decimal values across the codebase.
  */
object DecimalUtils {

  /** Conversion factor from USD to datum format. 1 USD = 100,000,000 datums (8 decimal places)
    */
  ...
  /** Converts a BigDecimal value to datum format (long value).
    ...
    * @return
    *   The value in datum format (multiplied by DATUM_USD)
    */
  ...
  /** Converts a datum format value to BigDecimal.
    *
    * @param value
    *   The datum format value to convert
    * @return
    *   The value as BigDecimal (divided by DATUM_USD)
    */
  ...
  /** Performs safe division, handling division by zero gracefully.
    ...
    *   The denominator
    * @param defaultValue
    *   The default value to return if denominator is zero
    * @return
    *   The result of division, or defaultValue if denominator is zero
    */
