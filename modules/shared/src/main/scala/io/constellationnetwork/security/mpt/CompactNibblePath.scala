...
object CompactNibblePath {
  ...
  /** Alias for fromNibbleSeq - creates CompactNibblePath from Seq[Nibble]. */
  def fromNibbles(nibbles: Seq[Nibble]): CompactNibblePath = fromNibbleSeq(nibbles)
