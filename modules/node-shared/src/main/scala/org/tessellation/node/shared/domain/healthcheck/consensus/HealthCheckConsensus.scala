...
import org.tessellation.node.shared.domain.healthcheck.consensus.HealthCheckConsensusRound
import org.tessellation.node.shared.domain.healthcheck.consensus.types.ConsensusRounds.InProgress
...
import org.tessellation.node.shared.domain.healthcheck.services.HealthCheck
