...
object CurrencySnapshotAcceptanceManager {
  def make[F[_]: Async: Parallel](
    ...
    tokenLockAcceptanceManager: CurrencyTokenLockAcceptanceManager[F],
    collateral: Amount,
  ...
  def make[F[_]: Async: Parallel](
    ...
    def accept(
      ...
      acceptedTokenUnlocks = tokenLockAcceptanceManager.acceptTokenUnlocks(
        expiredTokenLocksHashes,
        tokenUnlocks,
        tokenLocksRefs
      )
      ...
      (updatedActiveTokenLocks, expiredTokenLocks) <- tokenLockAcceptanceManager.acceptTokenLocks(
        lastGlobalSnapshotEpochProgress,
        acceptedTokenLocks,
        activeTokenLocks,
      ...
      updatedBalancesByTokenLocks = tokenLockAcceptanceManager.updateBalancesByTokenLocks(
        lastGlobalSnapshotEpochProgress,
      ...
      tokenUnlocksEvents <- tokenLockAcceptanceManager.emitTokenUnlocks(
        acceptedTokenUnlocks,
        expiredTokenLocks
      )
