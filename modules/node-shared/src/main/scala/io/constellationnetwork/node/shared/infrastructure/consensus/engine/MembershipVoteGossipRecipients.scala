...
/** Pure recipient policy shared by admission and eviction vote transport.
  ...
  * Legacy Global L0 and Currency L0 preserve their mutable current-facilitator transport. This selects transport recipients only; it does
  * not alter vote content, certificate authority, or consensus state.
  */
