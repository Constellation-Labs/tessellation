...
import org.tessellation.schema.currencyMessage.MessageType.Staking
...
import org.tessellation.schema.{GlobalSnapshotInfo, SnapshotOrdinal, SnapshotTips}
  ...
  val currencyIncrementalSnapshotGen: Gen[Signed[CurrencyIncrementalSnapshot]] =
    signedOf(
      CurrencyIncrementalSnapshot(
        ...
        stateProof = CurrencySnapshotStateProof(Hash.empty, Hash.empty, None, None, None, None),
