...
case class Version(
  /*
   * The rosetta_version is the version of the Rosetta interface the implementation adheres to. This can be useful for
  ...
  nodeVersion: String,
  /*
   * When a middleware org.tessellation.server is used to adhere to the Rosetta interface, it should return its version
   * here. This can help clients manage deployments.
   * */
