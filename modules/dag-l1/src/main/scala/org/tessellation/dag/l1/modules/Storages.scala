...
object Storages {
  ...
  def make[F[_]: Async: Random: KryoSerializer, T <: Transaction: Order: Ordering, B <: Block[T], S <: Snapshot[T, B]](
...
trait Storages[F[_], T <: Transaction, B <: Block[T], S <: Snapshot[T, B]] {
